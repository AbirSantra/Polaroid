        ...
        <div className="user-panel-container">
            <div className="user-panel">
                ...
                <div className="nav-links">
                    ...
                    <div
                        className={
                            formState ? "nav-link nav-link-active" : "nav-link"
                        }
                        onClick={handleOpen}
                    >
                        <div className="nav-link-logo">
                        ...
                        <div className="nav-link-text">Create a polaroid</div>
                    </div>
                    <NavLink
                        to="/saved"
                        className={({ isActive }) =>
                    ...
                    >
                        ...
                        <div className="nav-link-text">Saved Polaroids</div>
                    </NavLink>
                    <NavLink
                        to="/account"
                        className={({ isActive }) =>
                ...
                <div className="footer">
                    Polaroid | &copy; Copyright 2022 | Crafted and Coded by Abir
                    Santra
                </div>
            </div>
        </div>
